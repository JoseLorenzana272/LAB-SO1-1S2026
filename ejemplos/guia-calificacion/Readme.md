...
## ***IMPORTANTE: ADAPTAR los comandos a su cluster si tiene un namespace usar el "-n name" al final, al igual que el nombre de sus deploys o pods para adaptar el comando de logs 'kubectl logs nombre-del-deploy'***
